...
namespace CarWorkshop.MVC.Controllers
{
    public class CarWorkshopController : Controller
    {
        ...
        public async Task<IActionResult> Index() // zwracanie do klienta listy calej istniejacych car workshop
        {
        ...
        public async Task<IActionResult> Create(CreateCarWorkshopCommand command) {
            ...
            if (!ModelState.IsValid) //sprawdzanie walidacji modelu (czy wystarczajaco duzo liter cyfr itd itp)
            {
                return View(command); //chcemy klienta tu przekierowac znowu do CREATE 
            }
           // await _mediator.Send(command);
            this.SetNotification("succes", $"Created CarWorkshop: {command.Name}");
        ...
        public async Task<IActionResult> Edit(string encodedName,EditCarWorkshopCommand command)
        {
            ...
            {
                return View(command); // widok ten sam nic sie nie zmienia
            }
            await _mediator.Send(command);
            return RedirectToAction(nameof(Index));
        }
